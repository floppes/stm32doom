...
SRC_MAIN = button.c debug.c font.c gfx.c i2c.c jpeg.c lcd.c led.c main.c sdram.c spi.c syscalls.c touch.c vectors.c
...
LIB_ST   = stm32f4xx_dma.c stm32f4xx_dma2d.c stm32f4xx_exti.c stm32f4xx_fmc.c stm32f4xx_gpio.c stm32f4xx_i2c.c stm32f4xx_ltdc.c stm32f4xx_misc.c stm32f4xx_rcc.c stm32f4xx_sdio.c stm32f4xx_spi.c stm32f4xx_syscfg.c stm32f4xx_tim.c stm32f4xx_usart.c system_stm32f4xx.c
